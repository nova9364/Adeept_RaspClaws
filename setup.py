...
os.system("sudo pacman -Scc wolfram-engine")
os.system("sudo pacman -Scc libreoffice*")
os.system("sudo pacman -S clean")
os.system("sudo pacman -S autoremove")

# for x in range(1,4):
# 	if os.system("sudo pacman -Syu -y") == 0:
# 		break
...
for x in range(1, 4):
    if os.system("sudo pacman -S python-dev python-pip"
                 "libfreetype6-dev libjpeg-dev build-essential") == 0:
        break
...
for x in range(1, 4):
    if os.system("sudo pacman -S i2c-tools") == 0:
        break
...
for x in range(1, 4):
    if os.system("sudo pacman -Sy python3-smbus") == 0:
        break
...
for x in range(1, 4):
    if os.system(
            "sudo pacman -S llibqtgui4 libhdf5-dev libhdf5-serial-dev libatlas-base-dev libjasper-dev libqt4-test"
    ) == 0:
        break
...
for x in range(1, 4):
    if os.system(
            "sudo pacman -S -y util-linux procps hostapd iproute2 iw haveged dnsmasq"
    ) == 0:
        break
